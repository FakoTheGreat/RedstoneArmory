...
import RedstoneArmory.RFHelper;
import RedstoneArmory.items.ItemInfo;
import cofh.api.energy.IEnergyContainerItem;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class ItemEnderiumFluxedAxe extends ItemAxe implements IEnergyContainerItem {
	...
	public ItemEnderiumFluxedAxe(ToolMaterial material) {
		super(material);
		setCreativeTab(RedstoneArmory.RedstoneArmory.tabRedstoneArmory);
		setUnlocalizedName(ItemInfo.EFAXE_UNLOCALIZED_NAME);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFAXE_ICON);
		this.activeIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFAXE_ACTIVE_ICON);
		this.drainedIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFAXE_DRAINED_ICON);
	}

	@SideOnly(Side.CLIENT)
	public IIcon getIconIconFromEnergy(int energy, ItemStack container) {
