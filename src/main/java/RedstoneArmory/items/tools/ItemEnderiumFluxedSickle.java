...
public class ItemEnderiumFluxedSickle extends ItemShears implements IEnergyContainerItem {
	...
	public ItemEnderiumFluxedSickle(ToolMaterial material) {
		super();
		setCreativeTab(RedstoneArmory.RedstoneArmory.tabRedstoneArmory);
		setUnlocalizedName(ItemInfo.EFSICKLE_UNLOCALIZED_NAME);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFSICKLE_ICON);
		this.activeIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFSICKLE_ACTIVE_ICON);
		this.drainedIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFSICKLE_DRAINED_ICON);
	}
