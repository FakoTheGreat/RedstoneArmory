...
public class ItemEnderiumFluxedRod extends ItemFishingRod implements IEnergyContainerItem {
	
	@SuppressWarnings("unused")
	private IIcon uncastActiveIcon;
	private IIcon uncastDrainedIcon;
	private IIcon castActiveIcon;
	private IIcon castDrainedIcon;
	private IIcon castItemIcon;
	public int capacity = 160000;
	public int cost = 200;
	public int empoweredCost = 600;
	public int transferLimit = 1000;
	
	public ItemEnderiumFluxedRod(ToolMaterial material) {
		super();
		setCreativeTab(RedstoneArmory.RedstoneArmory.tabRedstoneArmory);
		setUnlocalizedName(ItemInfo.EFROD_UNLOCALIZED_NAME);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFROD_UNCAST_ICON);
		this.uncastActiveIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFROD_UNCAST_ACTIVE_ICON);
		this.uncastDrainedIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFROD_UNCAST_DRAINED_ICON);
		this.castItemIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFROD_UNCAST_ICON);
		this.castActiveIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFROD_UNCAST_ACTIVE_ICON);
		this.castDrainedIcon = iconRegister.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.EFROD_UNCAST_DRAINED_ICON);
	}
